...
import Parfumes from '../pages/Parfumes/Parfumes';
...
const mapStateToProps = ({ bags, cart, market }) => ({
  bags: market.items.filter(item => item.value.category === 'parfumes'),
...
export default withRouter(
  connect(mapStateToProps, mapDispatchToProps)(Parfumes)
);
