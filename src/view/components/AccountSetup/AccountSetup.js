    ...
    return (
        ...
        >
            ...
            <div className="info-buyer__block" style={{ opacity: loading ? '0.5' : '1' }}>
                ...
                <div>
                    <p>
                        In order to hide your identitity, the tracking number of the delivery is encrypted by buyer and
                        seller RSA public keys.
                    </p>
                    <p>
                        You set up this public key before. In order to display tracking number of your orders your RSA
                        private key is needed
                    </p>
                    <p>
                        <b>Note</b>: If you don’t need to see tracking numbers and delivery details you may skip filling
                        this form.
                    </p>
                </div>
                ...
                <div>
                    ...
                    <p>
                        ...
                        monthly. If it isn't rebilled in time the Free plan is set by default. You may update it in any
                        tim
                    </p>
                </div>
            </div>
